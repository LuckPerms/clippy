  ...
  tests: [
    {
      ...
      link:
        'https://luckperms.net/wiki/Storage-system-errors#luckperms-cannot-connect-to-my-mysql-server',
    },
    {
      checks: [
    ...
    },
    {
      ...
      link:
        'https://luckperms.net/wiki/Storage-system-errors#mysql-no-operations-allowed-after-connection-closed-error',
    },
    {
      checks: [
